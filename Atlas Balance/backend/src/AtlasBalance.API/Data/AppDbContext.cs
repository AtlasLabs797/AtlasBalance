...
public class AppDbContext : DbContext
{
    ...
    public DbSet<IaUsoUsuario> IaUsoUsuarios => Set<IaUsoUsuario>();
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Usuario>(entity =>
        {
            ...
            entity.HasIndex(e => e.PuedeUsarIa);
        ...
        modelBuilder.Entity<IaUsoUsuario>(entity =>
        {
            entity.ToTable("IA_USO_USUARIOS");
            entity.HasKey(e => e.Id);
            entity.Property(e => e.MonthKey).HasMaxLength(7).IsRequired();
            entity.Property(e => e.CosteEstimadoEur).HasPrecision(18, 8);
            entity.HasIndex(e => new { e.UsuarioId, e.MonthKey }).IsUnique();
