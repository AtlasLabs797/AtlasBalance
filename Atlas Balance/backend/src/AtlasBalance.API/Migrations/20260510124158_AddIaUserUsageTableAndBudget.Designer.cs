...
namespace AtlasBalance.API.Migrations
{
    ...
    [Migration("20260510124158_AddIaUserUsageTableAndBudget")]
    partial class AddIaUserUsageTableAndBudget
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AtlasBalance.API.Models.IaUsoUsuario", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<decimal>("CosteEstimadoEur")
                        .HasPrecision(18, 8)
                    ...
                    b.Property<DateTime>("FechaUltimoUsoUtc")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("fecha_ultimo_uso_utc");
                    ...
                    b.HasIndex("UsuarioId", "MonthKey")
                        .IsUnique()
                        .HasDatabaseName("ix_ia_uso_usuarios_usuario_id_month_key");
            ...
            modelBuilder.Entity("AtlasBalance.API.Models.IaUsoUsuario", b =>
                {
                    b.HasOne("AtlasBalance.API.Models.Usuario", "Usuario")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_ia_uso_usuarios_usuarios_usuario_id");
