...
SET valor = CASE clave
    ...
    WHEN 'minimax_api_key' THEN ''
    WHEN 'backup_destination' THEN 'LOCAL'
    WHEN 'google_drive_oauth_client_id' THEN ''
    WHEN 'google_drive_oauth_client_secret' THEN ''
    WHEN 'google_drive_folder_id' THEN ''
    WHEN 'backup_cloud_encryption_key' THEN ''
...
DELETE FROM "BACKUP_CLOUD_COPIES";
DELETE FROM "BACKUPS";
DELETE FROM "BACKUP_CLOUD_CONNECTIONS";
DELETE FROM "EXPORTACIONES";
DELETE FROM "REVISION_EXTRACTO_ESTADOS";
DELETE FROM "EXTRACTOS_COLUMNAS_EXTRA";
DELETE FROM "EXTRACTOS_DESGLOSES";
...
FROM (
    VALUES
        ...
        ('EXTRACTOS_DESGLOSES', (SELECT COUNT(*) FROM "EXTRACTOS_DESGLOSES")),
        ('INTEGRATION_TOKENS', (SELECT COUNT(*) FROM "INTEGRATION_TOKENS")),
        ('BACKUP_CLOUD_CONNECTIONS', (SELECT COUNT(*) FROM "BACKUP_CLOUD_CONNECTIONS")),
        ('BACKUP_CLOUD_COPIES', (SELECT COUNT(*) FROM "BACKUP_CLOUD_COPIES")),
